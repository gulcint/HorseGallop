...
val SurfaceDim = Color(0xFFE7D7C5)
val SurfaceBright = Color(0xFFFFFBF7)
val SurfaceContainerLowest = Color(0xFFFFFFFF)
val SurfaceContainerLow = Color(0xFFFEF6EE)
val SurfaceContainer = Color(0xFFF8ECDD)
val SurfaceContainerHigh = Color(0xFFF2E4D3)
val SurfaceContainerHighest = Color(0xFFEADBC9)
